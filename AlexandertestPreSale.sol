...
import "./Alexandertest.sol";

contract AlexandertestPreSale {
    Alexandertest public token;
    ...
    function AlexandertestPreSale(
        Alexandertest _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = Alexandertest(_token);
